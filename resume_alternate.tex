	...
	\begin{itemize}
		\item 
			\ressubsubheading{Morning Consult Data Scientist}{October 2015 - Current}
				{ \footnotesize
				\begin{itemize}
					\resitem{Automated company's polling process through the creation of an API interface.}
					\resitem{Created R packages to ..}
					\resitem{Worked directly with company cofounders on projects }
					\resitem{Assisted in several modeling tasks such as}
				\end{itemize}
				}
				\item 
