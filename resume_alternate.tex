		...
		\item 
			\ressubsubheading{Morning Consult Data Scientist}{October 2015 - Current}
				...
				\begin{itemize}
					...
					\resitem{Developed R package to connect to Lucid Fulcrum via the Fulcrum API to allow polling and data team members to programmatically interact with Fulcrum}
