...
\resheading{Experience}
	\begin{itemize}
        ...
        monitoring, and data analysis (Research has been cited by: \textit{The Washington Post, New York Times, 538, Fortune Magazine, The Hill, ABC, Huffington Post, Vox, Bloomberg, among others})}
					\resitem{Helped to improve statistical standards and develop best practices for the company’s polling methodology}
					\resitem{Constructed and validated state and congressional-level election forecasts based off national surveys using multilevel regression and post-stratification (MRP)}
		...
		\item 
			\ressubsubheading{Milwaukee Bucks Analytics Intern}{October 2014 - June 2015}
				{ \footnotesize
				\begin{itemize}
					\resitem{Used the web application framework Shiny in the R programming environment to create a portal for distributing important information to coaches and front office employees}
